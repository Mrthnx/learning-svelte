...
echo "🔧 Corrigiendo formularios para que coincidan con ViewModels..."

# Primero, copiar el plant-form como base pero con las correcciones necesarias

# Corregir Asset form - necesita campo RPM
cat > src/lib/components/modules/assets/asset-form.svelte << 'EOF'
<script lang="ts">
...
echo "✅ Asset form corregido con campo RPM"

# Ahora el user form correcto según ViewModel
cat > src/lib/components/modules/users/user-form.svelte << 'EOF'
<script lang="ts">
	import { Button } from '$lib/components/ui/button';
	import * as Card from '$lib/components/ui/card';
	import { Input } from '$lib/components/ui/input';
...
echo "✅ User form corregido con estructura correcta"

echo ""
echo "🎉 Formularios corregidos!"
echo "- Asset form: Ahora incluye campo RPM"
echo "- User form: Ahora usa la estructura correcta (name, lastName, email, active, etc.)"